# Generated by Django 5.0.6 on 2024-05-13 23:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('hr_contributor', 'HR Contributor')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_requirement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jobs.jobrequirement')),
            ],
            options={
